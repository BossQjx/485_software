...
//  GPIO_SetBits(GPIOD,GPIO_Pin_2);						 //PD.2上拉
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4;				 // PB12 推挽   上拉
 	GPIO_Init(GPIOA, &GPIO_InitStructure);					 //根据设定参数初始化GPIOB.12
 	GPIO_SetBits(GPIOA,GPIO_Pin_4);						 //PB.12上拉
...
void ENC28J60_Reset(void)
{
	...
	delay_ms(10);
//	SPI2_SetSpeed(SPI_BaudRatePrescaler_8);	//SPI1 SCK频率为72M/8=9Mhz
 	TIM2_Int_Init(1000,719);//100Khz计数频率，计数到1000为10ms     

...
extern u16 rtu_set_hldreg( u8 board_adr,u8 *com_buf, u16 start_address, u16 value );
int rtu_data_anlys( u8  *dest_p, u8 *source_p, u16 data_start_address, u16 fr_lenth);
void set_dout_value(u8 channel,u16 vl);
void set_all_dout_value(u16 vl);
